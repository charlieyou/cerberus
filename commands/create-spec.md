...
```bash
${CLAUDE_PLUGIN_ROOT}/bin/generate "$OUTPUT_DIR/spec-drafts" --type create-spec --mode "${MODE:-smart}" <<PROMPT
$(cat "${CLAUDE_PLUGIN_ROOT}/prompts/generators/create-spec.md")
