...
* prompt claude to return more context aboput pass vs maax iterations reached. block the stop hook, free it for the next hook run, and prompt with context?? code review shouldreturn p2/3/4 issues
