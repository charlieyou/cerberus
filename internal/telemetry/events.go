...
const (
	...
	EventRuntimeLaunched            = "cerberus.runtime.launched"
	EventRuntimeLaunchFailed        = "cerberus.runtime.launch_failed"
	EventRuntimeStarted             = "cerberus.runtime.started"
	EventRuntimeCompleted           = "cerberus.runtime.completed"
	EventRuntimeFailed              = "cerberus.runtime.failed"
	EventReviewerSpawned            = "cerberus.reviewer.spawned"
	EventReviewerStarted            = EventReviewerSpawned
	EventReviewerProcessLaunching   = "cerberus.reviewer.process_launching"
	EventReviewerProcessStarted     = "cerberus.reviewer.process_started"
	EventReviewerProcessCompleted   = "cerberus.reviewer.process_completed"
	EventReviewerProcessFailed      = "cerberus.reviewer.process_failed"
